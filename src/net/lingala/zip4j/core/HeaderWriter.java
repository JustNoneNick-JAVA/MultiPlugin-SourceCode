...
//			outputStream.write(byteArrayListToByteArray(headerBytesList));
	...
	private void writeZip64EndOfCentralDirectoryRecord(ZipModel zipModel, 
			...
			long offsetCentralDir, List<String> headerBytesList) throws ZipException {
		if (zipModel == null || outputStream == null) {
	...
	private void writeEndOfCentralDirectoryRecord(ZipModel zipModel, 
			...
			List<String> headrBytesList) throws ZipException {
		if (zipModel == null || outputStream == null) {
...
//				Raw.writeIntLittleEndian(intByte, 0, (int)offsetCentralDir);
	...
	private void copyByteArrayToArrayList(byte[] byteArray, List<String> arrayList) throws ZipException {
	...
	private byte[] byteArrayListToByteArray(List<String> arrayList) throws ZipException {
		if (arrayList == null) {
